        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-sm">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="sm:col-span-3">
              <label htmlFor="workplaceType" className="flex text-sm font-medium leading-6 text-gray-900">
                Workplace Type
              </label>
              <div className="mt-2">
                <select
          ...
          <p className="mt-10 text-center text-sm text-gray-500">
            If you want help writing job description, the Write with AI option will write it for you using information above with the help of AI.
          </p>
        </div>
      </div>
    </div>
